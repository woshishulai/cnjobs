...
const router = createRouter({
    ...
    routes: [
        ...
        {
            path: '/schools',
            component: () => import('@/pages/schools/SchoolList.vue'),
            name: 'Schools'
        },
        ...
        {
            path: '/user_center/info',
            component: () => import('@/pages/userCenter/Registration.vue')
        },
        {
            path: '/user_center/password',
            component: () => import('@/pages/userCenter/Password.vue')
        },
        {
            path: '/user_center/resume',
            component: () => import('@/pages/userCenter/Resume.vue'),
