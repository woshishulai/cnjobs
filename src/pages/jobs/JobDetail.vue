      ...
      <el-row :gutter="20">
        <el-col :xs="24" :sm="8" :md="6" class="job-promotion" style="margin-bottom: 40px">
          <div class="card-noborder" style="">
            <div>Recruiter in Charge: Contact our recruiter through WeChat:</div>
            <div
              class=""
              style="
                background-color: #f9f9f9;
                background-image: url(@/images/bg-emailbox.png);
            ...
            >
              <div>Dora.Wang</div>
              <div class="text-one-line">Email: dora.wang@toptutorjob.com</div>
            </div>
          </div>
        ...
        <el-col class="job-detail" :xs="24" :sm="16" :md="18">
          <div class="card-noborder">
            <div
              class="card-noborder"
              style="background: linear-gradient(to right, #f8f9fa, #ffffff); padding: 20px 40px"
            >
              <div style="width: 70%; display: inline-block">
                <div class="job-name" style="color: #1f2f57; font-size: 22px; margin-bottom: 20px">
            ...
            <div class="job" style="margin: 40px; line-height: 40px">
              ...
              <div class="">
                <img class="" src="@/images/icon-watch.png" />
                <span> Start in {{ job_info.start_time_en }}</span>
          ...
          <div class="job-desc card-noborder">
            ...
            <div class="job-desc-title">
              ...
              <label>Requirements Benefit</label>
            </div>
            <p>
          ...
          <div class="job-desc card-noborder">
            ...
            <div style="padding: 20px 0">
              <div style="width: 40%; display: inline-block">
                <img :src="job_info.school_logo" style="width: 100%; max-width: 300px" />
                <!--                <img src="@/images/school1.jpg" style="width: 100%; max-width: 300px" />-->
              </div>
              <div style="width: 60%; display: inline-block; line-height: 30px; padding-left: 20px">
                <div>
            ...
            <div class="card-noborder" style="background-color: #f9f9f9">
              <p :style="contentStyle">
                {{ job_info.school_profile }}
                <!--                The International Department of Shenzhen Foreign Language School (hereinafter-->
                <!--                referred to as the Shenzhen International Department) is located on the beautiful-->
                <!--                shore of Shenzhen Bay and is an international school invested and built by the-->
                <!--                Shenzhen Municipal Government for grades Pre-K to 12. The school covers an area of-->
                <!--                24000 square meters, with a building area of 42000 square meters, and has-->
                <!--                first-class hardware facilities. The construction area is located in a rapidly-->
                <!--                developing city like Shenzhen. The International Department of Shenzhen Foreign-->
                <!--                Studies has two main goals: to provide high-quality international education services-->
                <!--                for the children of foreign and Hong Kong, Macao, and Taiwan working in Shenzhen;-->
                <!--                And become a first-class international school in China and a window for-->
                <!--                international education in Shenzhen. The Shenzhen International Department has-->
                <!--                opened 54 classes and can accommodate 1080 students. In addition, the school's-->
                <!--                first-class hardware facilities and diverse extracurricular activities also provide-->
                <!--                strong support for the education and teaching of the Shenzhen Foreign Studies-->
                <!--                International Department.-->
              </p>
              <div @click="toggleContent" style="text-align: center">
                <el-icon style="transform: rotate(90deg)">
                  <DArrowRight />
                </el-icon>
              </div>
              <div style="text-align: center">
                <p @click="toggleContent" href="#">More</p>
              </div>
            </div>
          </div>
        </el-col>
